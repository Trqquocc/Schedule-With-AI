...
window.HabitsSection = {
  ...
  openModal(habit = null) {
    ...
    header.style.cssText =
      "background:linear-gradient(135deg,#22c55e,#16a34a);padding:20px 24px;display:flex;align-items:center;justify-content:space-between;";
    ...
    saveBtn.style.cssText =
      "padding:9px 20px;border-radius:10px;border:none;background:linear-gradient(135deg,#22c55e,#16a34a);" +
